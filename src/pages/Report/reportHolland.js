        ...
        <div className="card border-0 rounded shadow">
            ...
            <Row>
              <div className="col-8 container p-5 my-auto">
                ...
                <p
                  ...
                  style={{ fontSize: "35px", color: "#213555" }}
                >
                  Tes Kesesuaian Bidang
                </p>
                <p
                ...
                <p className="fw-bold mt-3 fs-5 text-white">
                  {dataReport?.fullname}
                </p>
                <p className="fw-bold mb-0 fs-5">
                  Email: <span className="text-white">{dataReport?.email}</span>
                </p>
                <p className="fw-bold mb-0 fs-5">
                  Perusahaan:{" "}
                  <span className="text-white">{dataReport?.name_company}</span>
                </p>
                <p className="fw-bold mb-0 fs-5">
                  Tanggal penyelesaian:{" "}
                  <span className="text-white">{dataReport?.jabatan}</span>
                </p>
                <p className="fw-bold mb-0 fs-5">
          ...
          <div id="pdfHidden2" className="page-break">
            <Row>
              ...
              <div className="col p-3">
                ...
                >
                  <span>
                    Tes Kesesuaian Bidang adalah tes minat bakat dan ditujukan
                    untuk melihat kemungkinan karir-karir yang cocok untuk Anda!
                    Model pilihan karir Holland menunjukkan bahwa seseorang akan
                    mencari lingkungan kerja yang sesuai dengan keterampilan,
                    kemampuan, sikap, dan nilai yang diyakini.
                  </span>
                </div>
                <p className="fs-5 mt-4 fw-bold">
                  Ada 6 tipe kepribadian dari Tes Kesesuaian Bidang:
                </p>
                <div
                ...
                >
                  <div style={{ width: "35px" }}>
                    <img src={r} height="auto" width="auto"/>
                  </div>
                  <div className="card ms-3">
                    <span className="ms-3">
                      ...
                      dengan orang lain secara <br/>langsung.
                    </span>
                  </div>
                </div>
                <div
                ...
                >
                  <div style={{ width: "68px" }}>
                    <img src={i} height="auto" width="auto"/>
                  </div>
                  <div className="card ms-3">
                    <span className="ms-3">
                ...
                >
                  <div style={{ width: "35px" }}>
                    <img src={a} height="auto" width="auto"/>
                  </div>
                  <div className="card ms-3">
                    <span className="ms-3">
                ...
                >
                  <div style={{ width: "35px" }}>
                    <img src={s} height="auto" width="auto"/>
                  </div>
                  <div className="card ms-3">
                    <span className="ms-3">
                ...
                >
                  <div style={{ width: "35px" }}>
                    <img src={e} height="auto" width="auto"/>
                  </div>
                  <div className="card ms-3">
                    <span className="ms-3">
                ...
                >
                  <div style={{ width: "35px" }}>
                    <img src={c} height="auto" width="auto"/>
                  </div>
                  <div className="card ms-3">
                    <span className="ms-3">
          ...
          >
            <p className="text-center text-uppercase fw-bold mt-2 text-white mb-2">
              Data Tes Kesesuaian Bidang (RIASEC)
            </p>
          </div>
                  ...
                  <ul className="fw-bold lh-xl no-bullets">
                    <li>
                      ...
                      <span className="text-white">
                        {dataReport?.skorjawaban?.R}
                      </span>
                    </li>
                    <li>
                      :{" "}
                      <span className="text-white">
                        {dataReport?.skorjawaban?.I}
                      </span>
                    </li>
                    <li>
                      :{" "}
                      <span className="text-white">
                        {dataReport?.skorjawaban?.A}
                      </span>
                    </li>
                    <li>
                      :{" "}
                      <span className="text-white">
                        {dataReport?.skorjawaban?.S}
                      </span>
                    </li>
                    <li>
                      :{" "}
                      <span className="text-white">
                        {dataReport?.skorjawaban?.E}
                      </span>
                    </li>
                    <li>
                      :{" "}
                      <span className="text-white">
                        {dataReport?.skorjawaban?.C}
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <Col md={4}>
                ...
                <div className="d-flex justify-content-center gap-2">
                  <div className="round-div">
                    <div
                      className="fw-bold p-3 rounded-circle text- text-center fs-4"
                      style={{ backgroundColor: "#0700C4", color: "#0700C4" }}
                    >
                  ...
                  <div className="round-div">
                    <div
                      className="fw-bold p-3 rounded-circle h-auto text- text-center fs-4"
                      style={{ backgroundColor: "#0052FF", color: "#0052FF" }}
                    >
                  ...
                  <div className="round-div">
                    <div
                      className="fw-bold p-3 rounded-circle h-auto text- text-center fs-4"
                      style={{ backgroundColor: "#00CCFF", color: "#00CCFF" }}
                    >
